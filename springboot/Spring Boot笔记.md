...
|                      | @ConfigurationProperties | @Value     | e.g     |
| -------------------- | ------------------------ | ---------- | ------- |
...
#### 解决tomcat配置成功但是http://39.97.166.249:8888/无法访问的wenti

```shell
root@iz2ze342kjcxfxx4kgoql2z ~]# docker exec -it 容器id /bin/bash
```

```shell
root@3717ecb232ee:/usr/local/tomcat# dir
BUILDING.txt     LICENSE  README.md      RUNNING.txt  conf  logs            temp     webapps.dist
CONTRIBUTING.md  NOTICE   RELEASE-NOTES  bin          lib   native-jni-lib  webapps  work
root@3717ecb232ee:/usr/local/tomcat# cp -r webapps.dist/* webapps
```

配置[阿里云控制台](https://ecs.console.aliyun.com/?spm=5176.100251.recommends.decs.32854f15sn0m3v#/securityGroupDetail/region/cn-beijing/groupId/sg-2zef6men8n9z9ju1mrqs/detail/intranetIngress)，开放端口![image-20201112101307324](D:\Users\acui\Documents\学习\springboot核心篇+整合篇-尚硅谷\01尚硅谷SpringBoot核心技术篇\Spring Boot 笔记+课件\image\image-20201112101307324.png)
